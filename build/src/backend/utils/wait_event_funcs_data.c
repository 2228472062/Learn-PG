 ...
 */
	...
	{"Activity", "ReplicationSlotsyncMain", "Waiting in main loop of slot synchronization"},
	...
	{"Buffer", "BufferCleanup", "Waiting to acquire an exclusive pin on a buffer. Buffer pin waits can be protracted if another process holds an open cursor that last read data from the buffer in question"},
	{"Buffer", "BufferExclusive", "Waiting to acquire a exclusive lock on a buffer"},
	{"Buffer", "BufferShared", "Waiting to acquire a shared lock on a buffer"},
	{"Buffer", "BufferShareExclusive", "Waiting to acquire a share exclusive lock on a buffer"},
	...
	{"IO", "CopyFromRead", "Waiting to read data from a pipe, a file or a program during COPY FROM"},
	{"IO", "CopyToWrite", "Waiting to write data to a pipe, a file or a program during COPY TO"},
	...
	{"IPC", "ChecksumEnableStartcondition", "Waiting for data checksums enabling to start"},
	{"IPC", "ChecksumEnableTemptableWait", "Waiting for temporary tables to be dropped for data checksums to be enabled"},
	...
	{"IPC", "RepackWorkerExport", "Waiting for decoding worker to export a new output file"},
	...
	{"IPC", "WaitForWalFlush", "Waiting for WAL flush to reach a target LSN on a primary or standby"},
	{"IPC", "WaitForWalReplay", "Waiting for WAL replay to reach a target LSN on a standby"},
	{"IPC", "WaitForWalWrite", "Waiting for WAL write to reach a target LSN on a standby"},
	{"IPC", "WalReceiverExit", "Waiting for the WAL receiver to exit"},
	{"IPC", "WalReceiverUpstreamCatchup", "Waiting for upstream server WAL flush position to catch up to requested start point"},
	...
	{"LWLock", "AioWorkerControl", "Waiting to update AIO worker information"},
	...
	{"LWLock", "DataChecksumsWorker", "Waiting for data checksums worker"},
	...
	{"LWLock", "LogicalDecodingControl", "Waiting to read or update logical decoding status information"},
	...
	{"LWLock", "NotifyChannelHash", "Waiting to access the NOTIFY channel hash table"},
	...
	{"Timeout", "CommitDelay", "Waiting for commit delay before WAL flush"},
