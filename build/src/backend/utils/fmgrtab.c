...
const FmgrBuiltin fmgr_builtins[] = {
  ...
  { 1544, 1, true, false, "circle_to_poly", circle_to_poly },
  ...
  { 3261, 2, true, false, "json_strip_nulls", json_strip_nulls },
  { 3262, 2, true, false, "jsonb_strip_nulls", jsonb_strip_nulls },
  ...
  { 4099, 0, true, false, "pg_numa_available", pg_numa_available },
  { 4100, 0, true, true, "pg_get_shmem_allocations_numa", pg_get_shmem_allocations_numa },
  ...
  { 6006, 2, true, false, "pg_replication_origin_session_setup", pg_replication_origin_session_setup },
  ...
  { 6119, 1, true, true, "pg_get_publication_tables_a", pg_get_publication_tables_a },
  ...
  { 6312, 2, true, false, "binary_upgrade_check_logical_slot_pending_wal", binary_upgrade_check_logical_slot_pending_wal },
  { 6313, 1, true, false, "pg_stat_get_backend_wal", pg_stat_get_backend_wal },
  ...
  { 6347, 1, true, false, "gist_translate_cmptype_common", gist_translate_cmptype_common },
  { 6348, 3, true, false, "has_largeobject_privilege_name_id", has_largeobject_privilege_name_id },
  { 6349, 2, true, false, "has_largeobject_privilege_id", has_largeobject_privilege_id },
  { 6350, 3, true, false, "has_largeobject_privilege_id_id", has_largeobject_privilege_id_id },
  { 6353, 0, true, true, "pg_get_loaded_modules", pg_get_loaded_modules },
  { 6354, 1, true, false, "generate_series_timestamp_support", generate_series_timestamp_support },
  { 6355, 1, true, false, "pg_stat_get_db_parallel_workers_to_launch", pg_stat_get_db_parallel_workers_to_launch },
  { 6356, 1, true, false, "pg_stat_get_db_parallel_workers_launched", pg_stat_get_db_parallel_workers_launched },
  { 6357, 1, true, false, "generate_series_numeric_support", generate_series_numeric_support },
  { 6358, 1, true, false, "pg_stat_get_total_vacuum_time", pg_stat_get_total_vacuum_time },
  { 6359, 1, true, false, "pg_stat_get_total_autovacuum_time", pg_stat_get_total_autovacuum_time },
  { 6360, 1, true, false, "pg_stat_get_total_analyze_time", pg_stat_get_total_analyze_time },
  { 6361, 1, true, false, "pg_stat_get_total_autoanalyze_time", pg_stat_get_total_autoanalyze_time },
  { 6362, 1, false, false, "pg_restore_relation_stats", pg_restore_relation_stats },
  { 6363, 1, false, false, "pg_restore_attribute_stats", pg_restore_attribute_stats },
  { 6364, 1, true, false, "crc32_bytea", crc32_bytea },
  { 6365, 1, true, false, "crc32c_bytea", crc32c_bytea },
  { 6366, 0, true, false, "pg_stat_get_checkpointer_slru_written", pg_stat_get_checkpointer_slru_written },
  { 6367, 1, true, false, "int2_bytea", int2_bytea },
  { 6368, 1, true, false, "int4_bytea", int4_bytea },
  { 6369, 1, true, false, "int8_bytea", int8_bytea },
  { 6370, 1, true, false, "bytea_int2", bytea_int2 },
  { 6371, 1, true, false, "bytea_int4", bytea_int4 },
  { 6372, 1, true, false, "bytea_int8", bytea_int8 },
  { 6375, 2, true, false, "record_larger", record_larger },
  { 6376, 2, true, false, "record_smaller", record_smaller },
  { 6377, 0, true, false, "pg_stat_get_checkpointer_num_performed", pg_stat_get_checkpointer_num_performed },
  { 6378, 1, true, false, "array_append_support", array_append_support },
  { 6379, 1, true, false, "array_prepend_support", array_prepend_support },
  { 6380, 1, true, false, "array_subscript_handler_support", array_subscript_handler_support },
  { 6381, 1, true, false, "array_reverse", array_reverse },
  { 6382, 1, true, false, "bytea_reverse", bytea_reverse },
  { 6383, 1, true, false, "dgamma", dgamma },
  { 6384, 1, true, false, "dlgamma", dlgamma },
  { 6385, 3, true, false, "pg_get_acl", pg_get_acl },
  { 6386, 1, true, true, "pg_stat_get_backend_io", pg_stat_get_backend_io },
  { 6387, 1, true, false, "pg_stat_reset_backend_stats", pg_stat_reset_backend_stats },
  { 6388, 1, true, false, "array_sort", array_sort },
  { 6389, 2, true, false, "array_sort_order", array_sort_order },
  { 6390, 3, true, false, "array_sort_order_nulls_first", array_sort_order_nulls_first },
  { 6391, 1, true, false, "range_sortsupport", range_sortsupport },
  { 6393, 2, true, false, "bytea_larger", bytea_larger },
  { 6394, 2, true, false, "bytea_smaller", bytea_smaller },
  { 6397, 2, false, false, "pg_clear_relation_stats", pg_clear_relation_stats },
  { 6398, 4, false, false, "pg_clear_attribute_stats", pg_clear_attribute_stats },
  { 6399, 0, true, true, "pg_get_aios", pg_get_aios },
  { 6400, 0, true, true, "pg_ls_summariesdir", pg_ls_summariesdir },
  { 6401, 0, true, true, "pg_timezone_abbrevs_zone", pg_timezone_abbrevs_zone },
  { 6402, 1, true, false, "btint2skipsupport", btint2skipsupport },
  { 6403, 1, true, false, "btint4skipsupport", btint4skipsupport },
  { 6404, 1, true, false, "btint8skipsupport", btint8skipsupport },
  { 6405, 1, true, false, "btoidskipsupport", btoidskipsupport },
  { 6406, 1, true, false, "btcharskipsupport", btcharskipsupport },
  { 6407, 1, true, false, "date_skipsupport", date_skipsupport },
  { 6408, 1, true, false, "btboolskipsupport", btboolskipsupport },
  { 6409, 1, true, false, "timestamp_skipsupport", timestamp_skipsupport },
  { 6410, 1, true, false, "uuid_skipsupport", uuid_skipsupport },
  { 6412, 1, true, false, "casefold", casefold },
  { 6413, 1, true, false, "hashbytea", hashbytea },
  { 6414, 2, true, false, "hashbyteaextended", hashbyteaextended },
  { 6415, 1, true, false, "hashdate", hashdate },
  { 6416, 2, true, false, "hashdateextended", hashdateextended },
  { 6417, 1, true, false, "hashbool", hashbool },
  { 6418, 2, true, false, "hashboolextended", hashboolextended },
  { 6419, 1, true, false, "hashxid", hashxid },
  { 6420, 2, true, false, "hashxidextended", hashxidextended },
  { 6421, 1, true, false, "hashxid8", hashxid8 },
  { 6422, 2, true, false, "hashxid8extended", hashxid8extended },
  { 6423, 1, true, false, "hashcid", hashcid },
  { 6424, 2, true, false, "hashcidextended", hashcidextended },
  { 6425, 1, true, false, "timestamptz_hash", timestamptz_hash },
  { 6426, 2, true, false, "timestamptz_hash_extended", timestamptz_hash_extended },
  { 6427, 1, true, false, "pg_get_sequence_data", pg_get_sequence_data },
  { 6428, 0, true, false, "gen_random_uuid", gen_random_uuid },
  { 6429, 0, true, false, "uuidv7", uuidv7 },
  { 6430, 1, true, false, "uuidv7_interval", uuidv7_interval },
  { 6431, 2, true, false, "date_random", date_random },
  { 6432, 2, true, false, "timestamp_random", timestamp_random },
  { 6433, 2, true, false, "timestamptz_random", timestamptz_random },
  { 6434, 1, true, true, "pg_get_publication_sequences", pg_get_publication_sequences },
  { 6435, 2, true, true, "pg_get_publication_tables_b", pg_get_publication_tables_b },
  { 6436, 1, true, false, "oidtooid8", oidtooid8 },
  { 6438, 1, true, false, "oid8in", oid8in },
  { 6439, 1, true, false, "oid8out", oid8out },
  { 6440, 1, true, false, "oid8recv", oid8recv },
  { 6441, 1, true, false, "oid8send", oid8send },
  { 6449, 2, true, false, "oid8eq", oid8eq },
  { 6450, 2, true, false, "oid8ne", oid8ne },
  { 6451, 2, true, false, "oid8lt", oid8lt },
  { 6452, 2, true, false, "oid8le", oid8le },
  { 6453, 2, true, false, "oid8gt", oid8gt },
  { 6454, 2, true, false, "oid8ge", oid8ge },
  { 6455, 2, true, false, "oid8larger", oid8larger },
  { 6456, 2, true, false, "oid8smaller", oid8smaller },
  { 6461, 1, true, false, "hashoid8", hashoid8 },
  { 6462, 2, true, false, "hashoid8extended", hashoid8extended },
  { 6463, 2, true, false, "btoid8cmp", btoid8cmp },
  { 6464, 1, true, false, "btoid8sortsupport", btoid8sortsupport },
  { 6465, 1, true, false, "btoid8skipsupport", btoid8skipsupport },
  { 6469, 1, true, false, "pg_get_propgraphdef", pg_get_propgraphdef },
  { 6485, 1, true, false, "regdatabasein", regdatabasein },
  { 6486, 1, true, false, "regdatabaseout", regdatabaseout },
  { 6487, 1, true, false, "to_regdatabase", to_regdatabase },
  { 6488, 1, true, false, "regdatabaserecv", regdatabaserecv },
  { 6489, 1, true, false, "regdatabasesend", regdatabasesend },
  { 6494, 0, true, true, "pg_stat_get_autovacuum_scores", pg_stat_get_autovacuum_scores },
  { 6495, 2, true, true, "multirange_minus_multi", multirange_minus_multi },
  { 6496, 2, true, true, "range_minus_multi", range_minus_multi },
  { 6497, 1, false, false, "pg_error_on_null", pg_error_on_null },
  { 6498, 1, true, false, "pg_stat_get_function_stat_reset_time", pg_stat_get_function_stat_reset_time },
  { 6499, 3, true, true, "pg_get_tablespace_ddl_oid", pg_get_tablespace_ddl_oid },
  { 6500, 3, true, true, "pg_get_tablespace_ddl_name", pg_get_tablespace_ddl_name },
  { 6501, 3, true, true, "pg_get_role_ddl", pg_get_role_ddl },
  { 6502, 4, true, true, "pg_get_database_ddl", pg_get_database_ddl },
  { 6503, 0, true, false, "pg_get_multixact_stats", pg_get_multixact_stats },
  { 6504, 1, true, false, "pg_stat_get_stat_reset_time", pg_stat_get_stat_reset_time },
  { 6505, 0, false, false, "binary_upgrade_create_conflict_detection_slot", binary_upgrade_create_conflict_detection_slot },
  { 6506, 2, true, false, "enable_data_checksums", enable_data_checksums },
  { 6507, 0, true, false, "disable_data_checksums", disable_data_checksums },
  { 6508, 0, true, true, "pg_get_dsm_registry_allocations", pg_get_dsm_registry_allocations },
  { 6509, 0, true, true, "pg_stat_get_lock", pg_stat_get_lock },
  { 6510, 1, true, false, "uuid_bytea", uuid_bytea },
  { 6511, 1, true, false, "bytea_uuid", bytea_uuid },
  { 6512, 1, false, false, "pg_restore_extended_stats", pg_restore_extended_stats },
  { 6513, 5, false, false, "pg_clear_extended_stats", pg_clear_extended_stats },
  { 6514, 0, false, false, "pg_stat_get_recovery", pg_stat_get_recovery },
  { 6515, 1, true, false, "tid_block", tid_block },
  { 6516, 1, true, false, "tid_offset", tid_offset },
  { 6519, 2, true, false, "uuid_larger", uuid_larger },
  { 6520, 2, true, false, "uuid_smaller", uuid_smaller },
  { 8683, 0, true, true, "pg_stat_get_kind_info", pg_stat_get_kind_info },
  { 9682, 1, true, true, "pg_stat_get_backend_lock", pg_stat_get_backend_lock }
};

const int fmgr_nbuiltins = (sizeof(fmgr_builtins) / sizeof(FmgrBuiltin));

const Oid fmgr_last_builtin_oid = 9682;

const uint16 fmgr_builtin_oid_index[9683] = {
