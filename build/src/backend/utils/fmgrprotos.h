...
extern Datum uuid_larger(PG_FUNCTION_ARGS);
extern Datum uuid_smaller(PG_FUNCTION_ARGS);
extern Datum pg_stat_get_kind_info(PG_FUNCTION_ARGS);
extern Datum pg_stat_get_backend_lock(PG_FUNCTION_ARGS);
