...
#line 1 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
...
static const yytype_int16 yyrline[] =
{
     ...
     255,   274,   328,   382,   394,   404,   405,   409,   426,   427,
     431,   432,   436,   437,   441,   442,   446,   455,   456,   457,
     461,   465,   466,   467,   471,   473,   478,   479,   480,   481,
...
#line 139 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                {
					do_start();
...
#line 150 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                {
					do_start();
...
#line 1303 "bootparse.c"
  ...
  case 16: /* $@1: %empty  */
#line 159 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                {
					do_start();
					numattr = 0;
...
#line 1317 "bootparse.c"
  ...
  case 17: /* $@2: %empty  */
#line 169 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                {
					do_end();
				}
...
#line 173 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                {
					TupleDesc	tupdesc;
...
#line 1409 "bootparse.c"
  ...
  case 19: /* $@3: %empty  */
#line 256 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                {
					do_start();
...
#line 262 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                {
...
#line 275 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                {
...
#line 329 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                {
					IndexStmt  *stmt = makeNode(IndexStmt);
					Oid			relationId;
...
#line 1543 "bootparse.c"
    break;

  case 23: /* Boot_DeclareToastStmt: XDECLARE XTOAST oidspec oidspec ON boot_ident  */
#line 383 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                {
...
#line 1556 "bootparse.c"
    break;

  case 24: /* Boot_BuildIndsStmt: XBUILD INDICES  */
#line 395 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                {
					do_start();
					build_indices();
					do_end();
...
#line 404 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                                                { (yyval.list) = lappend((yyvsp[-2].list), (yyvsp[0].ielem)); }
#line 1572 "bootparse.c"
    break;

  case 26: /* boot_index_params: boot_index_param  */
#line 405 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                                                                        { (yyval.list) = list_make1((yyvsp[0].ielem)); }
#line 1578 "bootparse.c"
    break;

  case 27: /* boot_index_param: boot_ident boot_ident  */
#line 410 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                {
...
#line 1596 "bootparse.c"
    break;

  case 28: /* optbootstrap: XBOOTSTRAP  */
#line 426 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                        { (yyval.ival) = 1; }
#line 1602 "bootparse.c"
    break;

  case 29: /* optbootstrap: %empty  */
#line 427 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                                { (yyval.ival) = 0; }
#line 1608 "bootparse.c"
    break;

  case 30: /* optsharedrelation: XSHARED_RELATION  */
#line 431 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                                { (yyval.ival) = 1; }
#line 1614 "bootparse.c"
    break;

  case 31: /* optsharedrelation: %empty  */
#line 432 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                                                { (yyval.ival) = 0; }
#line 1620 "bootparse.c"
    break;

  case 32: /* optrowtypeoid: XROWTYPE_OID oidspec  */
#line 436 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                                { (yyval.oidval) = (yyvsp[0].oidval); }
#line 1626 "bootparse.c"
    break;

  case 33: /* optrowtypeoid: %empty  */
#line 437 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                                                        { (yyval.oidval) = InvalidOid; }
#line 1632 "bootparse.c"
    break;

  case 36: /* boot_column_def: boot_ident EQUALS boot_ident boot_column_nullness  */
#line 447 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                {
				   if (++numattr > MAXATTR)
...
#line 455 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                                { (yyval.ival) = BOOTCOL_NULL_FORCE_NOT_NULL; }
#line 1648 "bootparse.c"
    break;

  case 38: /* boot_column_nullness: XFORCE XNULL  */
#line 456 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                                {  (yyval.ival) = BOOTCOL_NULL_FORCE_NULL; }
#line 1654 "bootparse.c"
    break;

  case 39: /* boot_column_nullness: %empty  */
#line 457 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                  { (yyval.ival) = BOOTCOL_NULL_AUTO; }
#line 1660 "bootparse.c"
    break;

  case 40: /* oidspec: boot_ident  */
#line 461 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                                                                        { (yyval.oidval) = atooid((yyvsp[0].str)); }
#line 1666 "bootparse.c"
    break;

  case 44: /* boot_column_val: boot_ident  */
#line 472 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                        { InsertOneValue((yyvsp[0].str), num_columns_read++); }
#line 1672 "bootparse.c"
    break;

  case 45: /* boot_column_val: NULLVAL  */
#line 474 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                        { InsertOneNull(num_columns_read++); }
#line 1678 "bootparse.c"
    break;

  case 46: /* boot_ident: ID  */
#line 478 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = (yyvsp[0].str); }
#line 1684 "bootparse.c"
    break;

  case 47: /* boot_ident: OPEN  */
#line 479 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1690 "bootparse.c"
    break;

  case 48: /* boot_ident: XCLOSE  */
#line 480 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1696 "bootparse.c"
    break;

  case 49: /* boot_ident: XCREATE  */
#line 481 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1702 "bootparse.c"
    break;

  case 50: /* boot_ident: INSERT_TUPLE  */
#line 482 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1708 "bootparse.c"
    break;

  case 51: /* boot_ident: XDECLARE  */
#line 483 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1714 "bootparse.c"
    break;

  case 52: /* boot_ident: INDEX  */
#line 484 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1720 "bootparse.c"
    break;

  case 53: /* boot_ident: ON  */
#line 485 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1726 "bootparse.c"
    break;

  case 54: /* boot_ident: USING  */
#line 486 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1732 "bootparse.c"
    break;

  case 55: /* boot_ident: XBUILD  */
#line 487 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1738 "bootparse.c"
    break;

  case 56: /* boot_ident: INDICES  */
#line 488 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1744 "bootparse.c"
    break;

  case 57: /* boot_ident: UNIQUE  */
#line 489 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1750 "bootparse.c"
    break;

  case 58: /* boot_ident: XTOAST  */
#line 490 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1756 "bootparse.c"
    break;

  case 59: /* boot_ident: OBJ_ID  */
#line 491 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1762 "bootparse.c"
    break;

  case 60: /* boot_ident: XBOOTSTRAP  */
#line 492 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1768 "bootparse.c"
    break;

  case 61: /* boot_ident: XSHARED_RELATION  */
#line 493 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1774 "bootparse.c"
    break;

  case 62: /* boot_ident: XROWTYPE_OID  */
#line 494 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1780 "bootparse.c"
    break;

  case 63: /* boot_ident: XFORCE  */
#line 495 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1786 "bootparse.c"
    break;

  case 64: /* boot_ident: XNOT  */
#line 496 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1792 "bootparse.c"
    break;

  case 65: /* boot_ident: XNULL  */
#line 497 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
...
#line 499 "/home/postgres/Learn-PG/build/../src/backend/bootstrap/bootparse.y"
