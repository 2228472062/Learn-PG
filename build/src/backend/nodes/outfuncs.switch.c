 ...
 */
			...
			case T_GraphLabelRef:
				_outGraphLabelRef(str, obj);
				break;
			case T_GraphPropertyRef:
				_outGraphPropertyRef(str, obj);
				break;
			case T_TargetEntry:
			...
			case T_PartitionCmd:
				...
				break;
			case T_GraphPattern:
				_outGraphPattern(str, obj);
				break;
			case T_GraphElementPattern:
				_outGraphElementPattern(str, obj);
				break;
			...
			case T_ForPortionOfClause:
				_outForPortionOfClause(str, obj);
				break;
			case T_WithClause:
			...
			case T_JsonTablePathSpec:
				...
				break;
			case T_JsonTablePlanSpec:
				_outJsonTablePlanSpec(str, obj);
				break;
			case T_JsonTable:
			...
			case T_CreatePropGraphStmt:
				_outCreatePropGraphStmt(str, obj);
				break;
			case T_PropGraphVertex:
				_outPropGraphVertex(str, obj);
				break;
			case T_PropGraphEdge:
				_outPropGraphEdge(str, obj);
				break;
			case T_PropGraphLabelAndProperties:
				_outPropGraphLabelAndProperties(str, obj);
				break;
			case T_PropGraphProperties:
				_outPropGraphProperties(str, obj);
				break;
			case T_AlterPropGraphStmt:
				_outAlterPropGraphStmt(str, obj);
				break;
			...
			case T_PublicationAllObjSpec:
				_outPublicationAllObjSpec(str, obj);
				break;
			...
			case T_MinMaxAggInfo:
				...
				break;
			case T_AggClauseInfo:
				_outAggClauseInfo(str, obj);
				break;
			case T_GroupingExprInfo:
				_outGroupingExprInfo(str, obj);
				break;
			...
			case T_PlanInvalItem:
				...
				break;
			case T_SubPlanRTInfo:
				_outSubPlanRTInfo(str, obj);
				break;
			case T_ElidedNode:
				_outElidedNode(str, obj);
				break;
