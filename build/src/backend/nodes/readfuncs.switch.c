 ...
 */
	...
	if (MATCH("GRAPHLABELREF", 13))
		return (Node *) _readGraphLabelRef();
	if (MATCH("GRAPHPROPERTYREF", 16))
		return (Node *) _readGraphPropertyRef();
	...
	if (MATCH("FORPORTIONOFEXPR", 16))
		return (Node *) _readForPortionOfExpr();
	if (MATCH("QUERY", 5))
	...
	if (MATCH("RANGEGRAPHTABLE", 15))
		return (Node *) _readRangeGraphTable();
	...
	if (MATCH("GRAPHPATTERN", 12))
		return (Node *) _readGraphPattern();
	if (MATCH("GRAPHELEMENTPATTERN", 19))
		return (Node *) _readGraphElementPattern();
	...
	if (MATCH("FORPORTIONOFCLAUSE", 18))
		return (Node *) _readForPortionOfClause();
	...
	if (MATCH("JSONTABLEPLANSPEC", 17))
		return (Node *) _readJsonTablePlanSpec();
	...
	if (MATCH("CREATEPROPGRAPHSTMT", 19))
		return (Node *) _readCreatePropGraphStmt();
	if (MATCH("PROPGRAPHVERTEX", 15))
		return (Node *) _readPropGraphVertex();
	if (MATCH("PROPGRAPHEDGE", 13))
		return (Node *) _readPropGraphEdge();
	if (MATCH("PROPGRAPHLABELANDPROPERTIES", 27))
		return (Node *) _readPropGraphLabelAndProperties();
	if (MATCH("PROPGRAPHPROPERTIES", 19))
		return (Node *) _readPropGraphProperties();
	if (MATCH("ALTERPROPGRAPHSTMT", 18))
		return (Node *) _readAlterPropGraphStmt();
	...
	if (MATCH("PUBLICATIONALLOBJSPEC", 21))
		return (Node *) _readPublicationAllObjSpec();
	...
	if (MATCH("SUBPLANRTINFO", 13))
		return (Node *) _readSubPlanRTInfo();
	if (MATCH("ELIDEDNODE", 10))
		return (Node *) _readElidedNode();
