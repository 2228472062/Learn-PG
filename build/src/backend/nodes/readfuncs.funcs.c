...
_readGraphLabelRef(void)
{
	READ_LOCALS(GraphLabelRef);

	READ_OID_FIELD(labelid);
	READ_LOCATION_FIELD(location);
...
_readGraphPropertyRef(void)
{
	READ_LOCALS(GraphPropertyRef);

	READ_STRING_FIELD(elvarname);
	READ_OID_FIELD(propid);
	READ_OID_FIELD(typeId);
	READ_INT_FIELD(typmod);
	READ_OID_FIELD(collation);
	READ_LOCATION_FIELD(location);
...
_readForPortionOfExpr(void)
{
	...
	READ_NODE_FIELD(targetFrom);
	READ_NODE_FIELD(targetTo);
	READ_NODE_FIELD(targetRange);
	READ_OID_FIELD(rangeType);
	READ_BOOL_FIELD(isDomain);
	READ_NODE_FIELD(overlapsExpr);
	READ_NODE_FIELD(rangeTargetList);
	READ_OID_FIELD(withoutPortionProc);
	READ_LOCATION_FIELD(location);
	READ_LOCATION_FIELD(targetLocation);
...
_readRangeGraphTable(void)
{
	READ_LOCALS(RangeGraphTable);

	READ_NODE_FIELD(graph_name);
...
static GraphPattern *
_readGraphPattern(void)
{
	READ_LOCALS(GraphPattern);

	READ_NODE_FIELD(path_pattern_list);
...
_readGraphElementPattern(void)
{
	READ_LOCALS(GraphElementPattern);

	READ_ENUM_FIELD(kind, GraphElementPatternKind);
	READ_STRING_FIELD(variable);
	READ_NODE_FIELD(labelexpr);
	READ_NODE_FIELD(subexpr);
	READ_NODE_FIELD(whereClause);
	READ_NODE_FIELD(quantifier);
	READ_LOCATION_FIELD(location);
...
_readForPortionOfClause(void)
{
	READ_LOCALS(ForPortionOfClause);

	READ_STRING_FIELD(range_name);
	READ_LOCATION_FIELD(location);
	READ_LOCATION_FIELD(target_location);
	READ_NODE_FIELD(target);
	READ_NODE_FIELD(target_start);
	READ_NODE_FIELD(target_end);
...
_readCreatePropGraphStmt(void)
{
	READ_LOCALS(CreatePropGraphStmt);

	READ_NODE_FIELD(pgname);
	READ_NODE_FIELD(vertex_tables);
	READ_NODE_FIELD(edge_tables);

	READ_DONE();
}

static PropGraphVertex *
_readPropGraphVertex(void)
{
	READ_LOCALS(PropGraphVertex);

	READ_NODE_FIELD(vtable);
	READ_NODE_FIELD(vkey);
	READ_NODE_FIELD(labels);
	READ_LOCATION_FIELD(location);
...
_readPropGraphEdge(void)
{
	READ_LOCALS(PropGraphEdge);

	READ_NODE_FIELD(etable);
	READ_NODE_FIELD(ekey);
	READ_NODE_FIELD(esrckey);
	READ_STRING_FIELD(esrcvertex);
	READ_NODE_FIELD(esrcvertexcols);
	READ_NODE_FIELD(edestkey);
	READ_STRING_FIELD(edestvertex);
	READ_NODE_FIELD(edestvertexcols);
	READ_NODE_FIELD(labels);
	READ_LOCATION_FIELD(location);
...
_readPropGraphLabelAndProperties(void)
{
	READ_LOCALS(PropGraphLabelAndProperties);

	READ_STRING_FIELD(label);
	READ_NODE_FIELD(properties);
	READ_LOCATION_FIELD(location);
...
_readPropGraphProperties(void)
{
	READ_LOCALS(PropGraphProperties);
...
_readAlterPropGraphStmt(void)
{
	READ_LOCALS(AlterPropGraphStmt);

	READ_NODE_FIELD(pgname);
	READ_BOOL_FIELD(missing_ok);
	READ_NODE_FIELD(add_vertex_tables);
	READ_NODE_FIELD(add_edge_tables);
	READ_NODE_FIELD(drop_vertex_tables);
	READ_NODE_FIELD(drop_edge_tables);
	READ_ENUM_FIELD(drop_behavior, DropBehavior);
	READ_ENUM_FIELD(element_kind, AlterPropGraphElementKind);
	READ_STRING_FIELD(element_alias);
	READ_NODE_FIELD(add_labels);
	READ_STRING_FIELD(drop_label);
	READ_STRING_FIELD(alter_label);
	READ_NODE_FIELD(add_properties);
	READ_NODE_FIELD(drop_properties);
...
_readPublicationAllObjSpec(void)
{
