...
static void
sql_help_ALTER_PROPERTY_GRAPH(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
					  "ALTER PROPERTY GRAPH %s ADD\n"
					  "    [ {VERTEX|NODE} TABLES ( %s [, ...] ) ]\n"
					  "    [ {EDGE|RELATIONSHIP} TABLES ( %s [, ...] ) ]\n"
					  "\n"
					  "ALTER PROPERTY GRAPH %s DROP\n"
					  "    {VERTEX|NODE} TABLES ( %s [, ...] ) [ CASCADE | RESTRICT ]\n"
					  "\n"
					  "ALTER PROPERTY GRAPH %s DROP\n"
					  "    {EDGE|RELATIONSHIP} TABLES ( %s [, ...] ) [ CASCADE | RESTRICT ]\n"
					  "\n"
					  "ALTER PROPERTY GRAPH %s ALTER\n"
					  "    {VERTEX|NODE|EDGE|RELATIONSHIP} TABLE %s\n"
					  "    { ADD LABEL %s [ NO PROPERTIES | PROPERTIES ALL COLUMNS | PROPERTIES ( { %s [ AS %s ] } [, ...] ) ] } [ ... ]\n"
					  "\n"
					  "ALTER PROPERTY GRAPH %s ALTER\n"
					  "    {VERTEX|NODE|EDGE|RELATIONSHIP} TABLE %s\n"
					  "    DROP LABEL %s [ CASCADE | RESTRICT ]\n"
					  "\n"
					  "ALTER PROPERTY GRAPH %s ALTER\n"
					  "    {VERTEX|NODE|EDGE|RELATIONSHIP} TABLE %s\n"
					  "    ALTER LABEL %s ADD PROPERTIES ( { %s [ AS %s ] } [, ...] )\n"
					  "\n"
					  "ALTER PROPERTY GRAPH %s ALTER\n"
					  "    {VERTEX|NODE|EDGE|RELATIONSHIP} TABLE %s\n"
					  "    ALTER LABEL %s DROP PROPERTIES ( %s [, ...] ) [ CASCADE | RESTRICT ]\n"
					  "\n"
					  "ALTER PROPERTY GRAPH %s OWNER TO { %s | CURRENT_USER | SESSION_USER }\n"
					  "ALTER PROPERTY GRAPH %s RENAME TO %s\n"
					  "ALTER PROPERTY GRAPH [ IF EXISTS ] %s SET SCHEMA %s",
					  _("name"),
					  _("vertex_table_definition"),
					  _("edge_table_definition"),
					  _("name"),
					  _("vertex_table_alias"),
					  _("name"),
					  _("edge_table_alias"),
					  _("name"),
					  _("element_table_alias"),
					  _("label_name"),
					  _("expression"),
					  _("property_name"),
					  _("name"),
...
sql_help_ALTER_PUBLICATION(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
					  ...
					  _("table_and_columns"),
					  _("schema_name"),
					  _("and publication_all_object is one of:"),
					  _("except_table_object"),
					  ...
					  _("column_name"),
					  _("expression"),
					  _("and except_table_object is:"),
					  _("table_object"),
					  _("and table_object is:"),
					  _("table_name"));
}
...
sql_help_ALTER_TABLE(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
					  ...
					  "ALTER TABLE [ IF EXISTS ] %s\n"
					  "    MERGE PARTITIONS (%s, %s [, ...]) INTO %s\n"
					  "ALTER TABLE [ IF EXISTS ] %s\n"
					  "    SPLIT PARTITION %s INTO\n"
					  "        (PARTITION %s { FOR VALUES %s | DEFAULT },\n"
					  "         PARTITION %s { FOR VALUES %s | DEFAULT } [, ...])\n"
					  "\n"
					  "%s\n"
					  "\n"
...
static void
sql_help_CREATE_PROPERTY_GRAPH(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
					  "CREATE [ TEMP | TEMPORARY ] PROPERTY GRAPH %s\n"
					  "    [ {VERTEX|NODE} TABLES ( %s [, ...] ) ]\n"
					  "    [ {EDGE|RELATIONSHIP} TABLES ( %s [, ...] ) ]\n"
					  "\n"
					  "%s\n"
					  ...
					  "%s\n"
					  "\n"
					  "    NO PROPERTIES | PROPERTIES ALL COLUMNS | PROPERTIES ( { %s [ AS %s ] } [, ...] )\n"
					  "\n"
					  "%s\n"
					  "\n"
					  "   { { LABEL %s | DEFAULT LABEL } [ NO PROPERTIES | PROPERTIES ALL COLUMNS | PROPERTIES ( { %s [ AS %s ] } [, ...] ) ] } [...]",
					  _("name"),
					  _("vertex_table_definition"),
					  _("edge_table_definition"),
					  _("where vertex_table_definition is:"),
					  _("vertex_table_name"),
					  _("alias"),
					  _("column_name"),
					  _("element_table_label_and_properties"),
					  _("and edge_table_definition is:"),
					  _("edge_table_name"),
					  _("alias"),
					  _("column_name"),
					  _("column_name"),
					  ...
					  _("column_name"),
					  _("element_table_label_and_properties"),
					  _("and element_table_label_and_properties is either:"),
					  _("expression"),
					  _("property_name"),
					  _("or:"),
					  _("label_name"),
...
sql_help_CREATE_TABLE(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
					  ...
					  _("value"),
					  _("tablespace_name"),
					  _("where persistence_mode is:"),
					  _("and column_storage is:"),
					  _("and column_compression is:"),
					  _("compression_method"),
					  _("and column_constraint is:"),
					  _("constraint_name"),
					  _("expression"),
					  ...
					  _("numeric_literal"),
					  _("numeric_literal"),
					  _("and index_parameters in UNIQUE, PRIMARY KEY, and EXCLUDE constraints are:"),
					  _("column_name"),
					  _("storage_parameter"),
					  _("value"),
					  _("tablespace_name"),
					  _("and exclude_element in an EXCLUDE constraint is:"),
					  _("column_name"),
					  _("expression"),
					  _("collation"),
					  _("opclass"),
					  _("opclass_parameter"),
					  _("value"),
					  _("and referential_action in a FOREIGN KEY/REFERENCES constraint is:"),
					  _("column_name"),
					  _("column_name"));
}
...
sql_help_DELETE(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
					  ...
					  _("output_expression"),
					  _("output_name"),
					  _("where for_portion_of_target is:"),
					  _("start_time"),
					  _("end_time"),
					  _("portion"));
}
...
static void
sql_help_DROP_PROPERTY_GRAPH(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
					  "DROP PROPERTY GRAPH [ IF EXISTS ] %s [, ...] [ CASCADE | RESTRICT ]",
					  _("name"));
}
...
sql_help_INSERT(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
					  ...
					  "\n"
					  "    DO NOTHING\n"
					  "    DO SELECT [ FOR { UPDATE | NO KEY UPDATE | SHARE | KEY SHARE } ] [ WHERE %s ]\n"
...
static void
sql_help_REPACK(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
					  "REPACK [ ( %s [, ...] ) ] [ %s [ USING INDEX [ %s ] ] ]\n"
					  "REPACK [ ( %s [, ...] ) ] USING INDEX\n"
					  "\n"
					  "%s\n"
					  "\n"
					  "    VERBOSE [ %s ]\n"
...
sql_help_SELECT(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
					  ...
					  "                [ WITH ORDINALITY ] [ [ AS ] %s [ ( %s [, ...] ) ] ]\n"
					  "    GRAPH_TABLE ( %s MATCH %s COLUMNS ( { %s [ AS %s ] } [, ...] ) ) [ [ AS ] %s [ ( %s [, ...] ) ] ]\n"
...
{
	appendPQExpBuffer(buf,
					  "SET [ SESSION | LOCAL ] %s { TO | = } { %s [, ...] | DEFAULT }\n"
...
static void
sql_help_WAIT_FOR(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
					  "WAIT FOR LSN '%s'\n"
					  "    [ WITH ( %s [, ...] ) ]\n"
...
const struct _helpStruct QL_HELP[] = {
	...
	{"ALTER PROPERTY GRAPH",
		N_("change the definition of an SQL-property graph"),
		"sql-alter-property-graph",
		sql_help_ALTER_PROPERTY_GRAPH,
	28},
	...
	{"CREATE PROPERTY GRAPH",
		N_("define a new SQL-property graph"),
		"sql-create-property-graph",
		sql_help_CREATE_PROPERTY_GRAPH,
	21},
	...
	{"DROP PROPERTY GRAPH",
		N_("remove an SQL-property graph"),
		"sql-drop-property-graph",
		sql_help_DROP_PROPERTY_GRAPH,
	0},
	...
	{"REPACK",
		N_("rewrite a table to reclaim disk space"),
		"sql-repack",
		sql_help_REPACK,
	11},
	...
	{"WAIT FOR",
		N_("wait for WAL to reach a target LSN"),
		"sql-wait-for",
		sql_help_WAIT_FOR,
	11},
