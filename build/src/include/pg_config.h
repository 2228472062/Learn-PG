...
#define CONFIGURE_ARGS " '--prefix=/home/postgres/Learn-PG/build' '--with-icu' '--with-openssl' '--with-systemd' '--with-libxml' '--enable-debug' '--enable-cassert' '--enable-depend' 'CFLAGS= -ggdb -O0 -g3 -Wall  -fno-omit-frame-pointer'"
...
#define HAVE_SSL_CTX_SET_CLIENT_HELLO_CB 1
...
#define PACKAGE_STRING "PostgreSQL 20devel"
...
#define PACKAGE_VERSION "20devel"
...
#define PG_MAJORVERSION "20"

/* PostgreSQL major version number */
#define PG_MAJORVERSION_NUM 20

/* PostgreSQL minor version number */
#define PG_MINORVERSION_NUM 0

/* PostgreSQL version as a string */
#define PG_VERSION "20devel"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 200000

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 20devel on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 13.3.0-6ubuntu2~24.04.1) 13.3.0, 64-bit"
...
#define USE_AVX2_WITH_RUNTIME_CHECK 1
